...
class TestKeyboard(Assertions):
    ...
    def test_reset_last_keys(self):
        ...
        self.assertEqual(types.PunishCnt, 0)
    ...
    def test_cheat_code_fund(self, mock_spend):
        ...
        self.assertEqual(types.PunishCnt, 1)
    ...
    def test_cheat_code_fund_fifth_time(self, mock_spend, mock_earthquake):
        ...
        types.PunishCnt = 4  # One less than trigger
        ...
        self.assertEqual(types.PunishCnt, 0)  # Reset to 0
    ...
    def test_cheat_code_fart(self, mock_make_sound, mock_fire, mock_flood,
                            mock_tornado, mock_earthquake, mock_monster):
    ...
    def test_cheat_code_will(self, mock_kick):
        ...
        with patch('src.micropolis.types.Rand') as mock_rand:
            ...
            self.assertNotEqual(types.Map, original_map)
            mock_kick.assert_called_once()
