...
def test_traffic_constants():
    ...
    assert macros.RAILHPOWERV == 221, (
        f"RAILHPOWERV should be 221, got {macros.RAILHPOWERV}"
    )
...
def test_road_test():
    ...
    assert not traffic.RoadTest(220), (
        "Power-rail tile 220 should be invalid"
    )  # Between POWERBASE and RAILHPOWERV
