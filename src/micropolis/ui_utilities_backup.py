...
This module contains various UI utility functions ported from w_util.c,
providing formatting, simulation control, and TCL command interfaces.
"""
...
def set_speed(speed: int) -> None:
    ...
    # For now, just update the simulation control
...
class UIUtilitiesCommand:
    ...
    def handle_command(self, command: str, *args) -> str:
        ...
        if command == "pause":
            ...
            raise ValueError(f"Unknown UI utility command: {command}")</content>
<parameter name="filePath">c:\Users\cyrex\files\projects\micropolis\src\micropolis\ui_utilities.py